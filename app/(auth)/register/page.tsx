    ...
    <main className="flex min-h-screen w-full">
      ...
      >
        ...
        <div className="my-8 flex items-center gap-4 text-xs font-medium uppercase text-slate-400">
          ...
          <span className="whitespace-nowrap">Ou cadastre-se com</span>
          <div className="h-[1px] w-full bg-slate-200"></div>
        </div>
        ...
        <div className="flex h-full w-full flex-col justify-center">
          <div className="mt-8 flex flex-col gap-6">
            <h2 className="font-roboto text-4xl font-bold leading-tight">
              Junte-se a nós e <span className="text-indigo-300">comece a</span>{" "}
              <br />{" "}
              <span className="text-indigo-300">organizar suas tarefas</span>
            </h2>
